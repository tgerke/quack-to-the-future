...
::: notes
No clicks here; the whole argument is on the slide. Left column is the room's reflex: git, renv, CI on every push. Right column names the real practice with respect: ISO-dated folders and suffixes are discipline, but there's no author, no diff, no rollback. Land on the last line and say the stem out loud: data pipelines need a paper trail, what changed, who changed it, why, and where every column came from. That sentence is the spine of the talk: what, who, why is chapters one and two; where every column came from is chapter three; and "paper trail" pays off at the Part III turn and the summary slide.
:::
