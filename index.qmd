...
<div class="polaroid">
<img src="images/stills/fading-photo.webp" class="no-round fragment custom fade-history" style="width: 440px;" alt="Marty's fading family photograph"/>
</div>
:::
:::
...
::: notes
The whole cold open on one slide. The folder gets the laugh: filenames are our version control, Slack is our audit log, memory is our lineage system. Click: the photo fades. Every overwrite of an existing file is Marty's siblings disappearing; the present looks fine, and what the data looked like, who changed it, and why are quietly erased. Click: the question everyone in the room has been asked, and the honest answer. This is Marty's alternate 1985: someone changed your data upstream, and you're living in the wrong timeline of your own report; pays off at the change-feed and almanac slides. Click: the ask, out loud in minute one. Next slide: the fix is already in this room's muscle memory.
:::
