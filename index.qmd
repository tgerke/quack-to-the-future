...
The data your code produces gets none of that.

[Overwrite and hope.]{.orange}
:::

::: notes
Name the double standard plainly. This community made code versioning a norm: git, renv, lockfiles, CI on every push. Then the pipeline's output lands in a CSV with no history at all. Nobody chose that on purpose; the tooling made one easy and the other hard.
:::
...
The lake remembers everything. Time to drive.
:::
