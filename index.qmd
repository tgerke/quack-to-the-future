...
::: notes
Every team has a Biff. Sometimes Biff is you, at 4:47 PM. The point isn't preventing the mistake — it's that the mistake is now visible, attributed, and reversible.
:::
...
::: {.quiet}
In my world — prostate cancer clinical trials — "trust me" is not an audit trail. *This* is what a regulator can read.
:::
:::
:::
...
Not "these tables are related" — **this cell traces to that column, via this expression.**
...
- {dplyneage} walks that tree directly — **pure R**, exact attribution
...
Lineage as **data**, not just a picture:
...
::: notes
Bring the stem back: what changed, who, why — ducklake. Where every column came from — dplyneage. Same lazy tables, so they compose with zero glue.
:::
